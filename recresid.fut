...
-- Map recresid. First step is to figure out OLS i think.
-- entry mrecresid [m][N][k] (bsz: i64) (X: [N][k]f64) (image: [m][N]f64) =
  -- let tol = f64.sqrt(f64_eps) / (f64.i64 k
  -- Compute non nan indices "filterPadWithKeys" approach.
